...
namespace WindowsFormsTestApp
{
    public partial class Form1 : Form
    {
        ...
        private void noclmasterBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            this.tableAdapterManager.UpdateAll(this.nocl_masterDataSet);

        }

        private void Form1_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'nocl_masterDataSet.noclmaster' table. You can move, or remove it, as needed.
            this.noclmasterTableAdapter.Fill(this.nocl_masterDataSet.noclmaster);
